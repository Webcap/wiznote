...
export function getSecurityHeaders(): SecurityHeaders {
  return {
    ...
    'Content-Security-Policy': [
      ...
      "connect-src 'self' https://*.supabase.co https://auth.wiznote.app wss://auth.wiznote.app https://generativelanguage.googleapis.com https://api.stripe.com https://api.webcap.media https://ingesteer.services-prod.nsvcs.net https://api.ipify.org https://api64.ipify.org https://ipapi.co wss://*.supabase.co",
