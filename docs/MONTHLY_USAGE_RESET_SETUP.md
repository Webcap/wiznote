...
- The reset functions require an **admin key** (secret key or service role key), not the anon key
- They need to bypass Row Level Security (RLS) policies to update usage records
